...
export const property: PropertyData = {
  ...
  depositPromo: 'Promoción especial: 50% de descuento en el depósito para ingresar',
  area: 200,
  areaUnit: 'm²',
  bathrooms: 1,
  maxOccupancy: 3,
  ...
  description: 'Apartamento en La Siesta de Tocumen, con entrada independiente, baño, área de lavado, preferiblemente para parejas. No se aceptan perros grandes. Aprovecha la promoción de la mitad del precio del depósito para ingresar.',
  location: {
    country: 'Panamá',
    city: 'Panamá',
    ...
    barriada: 'La Siesta',
    street: 'Calle Amador',
    fullAddress: 'Calle Amador, Barriada La Siesta, Corregimiento de Tocumen, Ciudad de Panamá, Panamá',
    googleMapsUrl: 'https://maps.app.goo.gl/wtWBXzSNpBpzRH1P9',
  },
  contact: {
    recipientEmail: 'scabeza@outlook.com',
    whatsappUrl: 'https://wa.me/50761196368?text=Hola,%20estoy%20interesado%20en%20el%20alquiler%20del%20cuarto%20en%20La%20Siesta%20de%20Tocumen',
  },
  features: [
    {
      icon: 'door_front',
    ...
    },
    {
      ...
      description: 'En La Siesta de Tocumen, con fácil acceso a transporte y comercios.',
    },
  ],
  images: [
    {
